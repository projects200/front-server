...
export default function Profile() {
  ...
  const handleBottomButton = async () => {
    ...
    try {
      ...
      router.push(`${SITE_MAP.CHAT_ROOM}?nickName=${profileData.nickname}&chatRoomId=${res.data.chatRoomId}&memberId=${memberId}`)
    } catch {}
  }
  ...
  return (
    <>
      ...
      {/* 바텀 버튼 */}
      <BottomButton className={styles['bottom-button']} onClick={handleBottomButton}>
        1:1 채팅하기
      </BottomButton>
